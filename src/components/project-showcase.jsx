...
const projects = [
  {
    name: "Sudo Website",
    description: "A website project that present the Discord server SUDO",
    madeby: "Shadi",
...
function ProjectShowcase() {
  return (
    <div className="p-10 items-center border shadow md:flex-row w-full dark:border-gray-700 dark:bg-slate-900 flex-1">
          ...
          <div className="border border-red-700 rounded-lg shadow text-white">
            ...
            <div className=" flex flex-col items-center justify-center basis-1/4">
              <button
                ...
                className=" bg-red-600 text-white p-2 rounded m-2 text-lg hover:bg-red-800 hover:text-gray-200"
                type="button"
              >
                Link to Project
              </button>
